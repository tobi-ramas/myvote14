...
mobile_user_agent = "Mozilla/5.0 (Linux; Android 10; TA-1241) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/88.0.4324.152 Mobile Safari/537.36"
...
try:
    ...
    driver.add_cookie({'name': 'PHPSESSID', 'value': 'b4b2d6ed8c9be6ee249966c07d75f3f3'})
    time.sleep(2)
    # to refresh the page
    driver.refresh()
